            ...
            <nav>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item text-warning" href="UserUpdateInfo.php">Update Account Info</a>
                        <a class="dropdown-item text-warning" href="UserDelete.php">Delete Account</a>
